...
export const ShellSearch = () => {
  ...
  return (
    <form
      onSubmit={handleSubmit}
      className="flex items-center gap-1 rounded-full bg-white dark:bg-[var(--ds-surface-overlay,#2B2C2F)] px-2.5 py-0.5 border border-slate-200 dark:border-[var(--ds-surface-overlay,#2B2C2F)] w-full focus-within:ring-2 focus-within:ring-[#3725c7]"
    >
