...
const Row = ({
  ...
  <div className="flex flex-col gap-2">
    {label && (
      <p className="text-ds-xs text-muted-foreground font-medium uppercase tracking-wide">
        {label}
      </p>
    )}
      ...
      <tbody className="divide-y divide-border">
        {rows.map((r) => (
          <tr key={r.prop} className="hover:bg-muted/20">
            ...
            <td className="px-4 py-2.5 font-mono text-warning-foreground">
              {r.default}
            </td>
...
const ButtonsSection = () => {
  ...
  return (
    <Section
      ...
      icon={Zap}
      title="Button"
      description="Action triggers with 17+ variants, 9 sizes, icon slots, loading state, and grouped layout."
    >
      <DemoBlock
...
<Button variant="outline-info">Info</Button>`}
      >
        <Row>
          {(
            ...
            <Button key={v} variant={v}>
              {v.replace("outline-", "").charAt(0).toUpperCase() +
                v.replace("outline-", "").slice(1)}
            </Button>
          ))}
        </Row>
      </DemoBlock>
      ...
      <DemoBlock
        label="Soft / ghost / link"
        code={`<Button variant="soft-primary">Soft Primary</Button>
...
<Button size="xxl">xxl</Button>`}
      ...
      <DemoBlock
        label="Icon variants"
        code={`<Button size="icon" variant="primary"><Bell /></Button>
...
<Button iconEnd={<ArrowRight />}>With end icon</Button>`}
      >
        <Row>
          ...
          <Button size="icon-lg" variant="soft-success">
      ...
      <DemoBlock
        label="States: loading · disabled · block"
        ...
        rows={[
          {
            ...
            type: "string",
            default: '"primary"',
            desc: "Visual style: primary | secondary | success | danger | warning | info | light | dark | outline-* | soft-* | ghost | link",
          },
          {
            prop: "size",
            type: "string",
            default: '"default"',
            desc: "xs | sm | default | md | lg | xl | xxl | icon | icon-sm | icon-lg",
          },
          {
            prop: "isLoading",
            type: "boolean",
            default: "false",
            desc: "Shows spinner and disables interaction",
          },
          {
            prop: "loadingText",
            type: "string",
            default: "—",
            desc: "Text shown while loading (fallback: children)",
          },
          {
            prop: "iconStart",
            type: "ReactNode",
            default: "—",
            desc: "Icon rendered before label",
          },
          {
            prop: "iconEnd",
            type: "ReactNode",
            default: "—",
            desc: "Icon rendered after label",
          },
          {
            prop: "block",
            type: "boolean",
          ...
          },
          {
            ...
            type: "string",
            default: '"button"',
            desc: '"button" | "submit" | "reset" | "link" | "navlink"',
          },
        ]}
      />
    </Section>
...
const CardsSection = () => (
  <Section
    ...
    icon={Box}
    title="Card"
    description="Composable card with header, body, footer slots and 5 elevation levels."
  >
    <DemoBlock
      label="Elevation levels"
      code={`<Card elevation="flat">Flat</Card>
...
<Card elevation="high">High</Card>`}
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
        {(["flat", "raised", "medium", "high"] as const).map((e) => (
          <Card key={e} elevation={e} className="p-4">
            ...
            <p className="text-ds-xs text-muted-foreground mt-1">
              elevation="{e}"
            </p>
          </Card>
        ))}
    ...
    <DemoBlock
      label="Full structure: Header · Body · Footer"
      code={`<Card>
  ...
  <CardFooter divider>
    ...
    >
      <Card className="max-w-sm">
        <CardHeader
          action={<Badge variant="soft-primary">New</Badge>}
          divider
          onClose={() => {}}
        >
          <CardTitle>Card Title</CardTitle>
          <CardDescription>
            Supporting description that spans two lines to show truncation
            behaviour.
          </CardDescription>
        </CardHeader>
        <CardBody>
          <p className="text-ds-sm text-muted-foreground">
            Main content area. Place any content here — tables, forms, lists,
            charts, etc.
          </p>
        </CardBody>
        <CardFooter divider>
    ...
    >
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
        <Card hoverable>
          ...
          <CardBody>
            <p className="text-ds-sm text-muted-foreground">
              Hover this card to see shadow elevation.
            </p>
          </CardBody>
        </Card>
      ...
      rows={[
        {
          ...
          type: "string",
          default: '"raised"',
          desc: "flat | raised | medium | high | overlay",
        },
        {
          prop: "hoverable",
          type: "boolean",
          default: "false",
          desc: "Lifts shadow on hover",
        },
        {
          prop: "CardHeader.divider",
          type: "boolean",
          default: "false",
          desc: "Bottom divider line",
        },
        {
          prop: "CardHeader.accent",
          type: "boolean",
          default: "false",
          desc: "Subtle primary tinted background",
        },
        {
          prop: "CardHeader.onClose",
          type: "() => void",
          default: "—",
          desc: "Renders a close (×) button",
        },
        {
          prop: "CardHeader.action",
          type: "ReactNode",
          default: "—",
          desc: "Right-side slot (badge, icon, buttons)",
        },
        {
          prop: "CardFooter.divider",
          type: "boolean",
          default: "false",
          desc: "Top divider line",
        },
      ]}
    />
  </Section>
...
const AlertsSection = () => (
  <Section
    ...
    icon={Info}
    title="Alert"
    description="Inline feedback messages with auto-icon mapping, dismiss action, and 6 semantic variants."
  >
    <DemoBlock
      label="All variants (auto icon)"
      code={`<Alert variant="primary"><AlertTitle>Primary</AlertTitle><AlertDescription>Info message</AlertDescription></Alert>
...
<Alert variant="info"><AlertTitle>Info</AlertTitle><AlertDescription>Helpful context</AlertDescription></Alert>`}
        ...
        {[
          {
            v: "primary" as const,
            title: "Primary",
            desc: "This is a primary informational alert.",
          },
          {
            v: "success" as const,
            title: "Success",
          ...
          },
          {
            v: "info" as const,
            title: "Info",
            desc: "New version available — refresh to update.",
          },
        ].map(({ v, title, desc }) => (
    ...
    <DemoBlock
      label="Dismissible"
      code={`<Alert variant="success" onDismiss={() => setVisible(false)}>
  ...
  <AlertDescription>Your profile has been updated.</AlertDescription>
    ...
    <DemoBlock
      label="No icon / custom icon"
      code={`<Alert variant="info" icon={false}>No icon</Alert>
<Alert variant="warning" icon={<Star className="h-4 w-4" />}>Custom icon</Alert>`}
    >
      <div className="space-y-2">
        <Alert variant="info" icon={false}>
          <AlertDescription>
            Alert without an icon — pass{" "}
            <code className="font-mono text-xs">icon&#123;false&#125;</code>.
          </AlertDescription>
        </Alert>
        <Alert variant="warning" icon={<Star className="h-4 w-4" />}>
          <AlertDescription>
            Custom icon via the <code className="font-mono text-xs">icon</code>{" "}
            prop.
          </AlertDescription>
        </Alert>
      </div>
      ...
      rows={[
        {
          ...
          type: "string",
          default: '"default"',
          desc: "default | primary | success | danger | warning | info | destructive",
        },
        {
          prop: "icon",
          type: "boolean | ReactNode",
          default: "true",
          desc: "true = auto icon, false = none, ReactNode = custom",
        },
        {
          prop: "onDismiss",
          type: "() => void",
          default: "—",
          desc: "Renders a dismiss (×) button",
        },
      ]}
    />
  </Section>
...
const BadgesSection = () => (
  <Section
    ...
    icon={Star}
    title="Badge"
    description="Status indicators with 16+ variants across solid, soft, and outline styles."
  >
    <DemoBlock
      label="Solid"
...
<Badge variant="info">Info</Badge>`}
    ...
    <DemoBlock
      label="Soft / Outline / Dot"
      code={`<Badge variant="soft-primary">Soft</Badge>
    ...
    >
      <div className="space-y-2">
        ...
        <Row label="Dot indicator">
          ...
          <Badge variant="soft-danger" dot>
            Offline
          </Badge>
          <Badge variant="soft-warning" dot>
            Away
          </Badge>
          <Badge variant="soft-info" dot>
            Busy
          </Badge>
        </Row>
      </div>
      ...
      rows={[
        {
          ...
          type: "string",
          default: '"primary"',
          desc: "primary | secondary | success | danger | warning | info | dark | soft-* | outline | outline-* | destructive",
        },
        {
          prop: "size",
          type: "string",
        ...
        },
        {
          ...
          type: "boolean",
          default: "false",
          desc: "Prepends a coloured dot indicator",
        },
      ]}
    />
  </Section>
...
const FormsSection = () => {
  ...
  return (
    <Section
      ...
      icon={Type}
      title="Form Elements"
      description="Input, Textarea, Checkbox, and Radio with consistent sizing, states, and color variants."
    >
      <DemoBlock
        label="Input — sizes & states"
...
<Input placeholder="With icons" iconStart={<Search />} iconEnd={<Check />} />`}
      >
        <div className="max-w-sm space-y-2">
          ...
          <Input
            ...
            iconEnd={<Lock className="h-4 w-4" />}
          />
      ...
      <DemoBlock
        label="Textarea"
        code={`<Textarea placeholder="Enter notes..." />
      ...
      >
        <div className="max-w-sm space-y-2">
          ...
          <Textarea
            ...
            hint="Fixed height, no resize handle."
          />
        </div>
      </DemoBlock>

      <DemoBlock
        label="Checkbox — sizes & color schemes"
...
<Checkbox colorScheme="danger" label="Delete all" />`}
        ...
        <div className="space-y-3">
          ...
          <Row label="States">
            <Checkbox
              checked={checked}
              onCheckedChange={
                setChecked as (v: boolean | "indeterminate") => void
              }
              label="Toggle me"
            />
      ...
      <DemoBlock
        label="Radio Group — sizes & color schemes"
        code={`<RadioGroup value={radio} onValueChange={setRadio} className="flex gap-4">
      ...
      <PropsTable
        rows={[
          ...
          },
          {
            ...
            type: "string | boolean",
            default: "—",
            desc: "Error text (shown below) or boolean to trigger red border",
          },
          {
            prop: "Input.hint",
            type: "string",
            default: "—",
            desc: "Helper text shown when no error",
          },
          {
            prop: "Input.iconStart / iconEnd",
            type: "ReactNode",
            default: "—",
            desc: "Icon overlaid inside the input",
          },
          {
            prop: "Checkbox.colorScheme",
            type: "string",
            default: '"primary"',
            desc: "primary | success | danger | warning | info",
          },
          {
            prop: "Checkbox.size",
            type: "string",
            default: '"default"',
            desc: "sm | default | lg | xl",
          },
          {
            prop: "Checkbox.label",
            type: "string",
            default: "—",
            desc: "Renders a label wrapped around the checkbox",
          },
          {
            prop: "RadioGroupItem.colorScheme",
            type: "string",
            default: '"primary"',
            desc: "primary | success | danger | warning | info",
          },
...
const FeedbackSection = () => {
  ...
  return (
    <Section
      ...
      description="Multi-color progress bars (striped, animated, labelled) and size/color spinners."
    >
      <DemoBlock
        label="Progress — color schemes"
        code={`<Progress value={65} colorScheme="primary" />
...
<Progress value={70} colorScheme="info" />`}
          ...
          {(["primary", "success", "danger", "warning", "info"] as const).map(
            (c) => (
              <div key={c} className="flex items-center gap-3">
                <span className="w-16 text-ds-xs text-muted-foreground capitalize">
                  {c}
                </span>
      ...
      <DemoBlock
        label="Sizes · striped · animated · labelled"
        code={`<Progress value={70} size="xs" />
...
<Progress value={70} size="xl" animated showLabel />`}
      ...
      <DemoBlock
        label="Spinner — colors & sizes"
        code={`<Spinner colorScheme="primary" />
...
<Spinner colorScheme="danger" size="xl" />`}
      ...
      <DemoBlock
        label="SpinnerOverlay — on a card"
  ...
  <SpinnerOverlay label="Loading data..." />
      ...
      <PropsTable
        rows={[
          {
            prop: "Progress.colorScheme",
            type: "string",
            default: '"primary"',
            desc: "primary | success | danger | warning | info | secondary",
          },
          {
            prop: "Progress.size",
            type: "string",
            default: '"default"',
            desc: "xs | sm | default | lg | xl",
          },
          {
            prop: "Progress.striped",
            type: "boolean",
            default: "false",
            desc: "Diagonal stripe pattern overlay",
          },
          {
            prop: "Progress.animated",
            type: "boolean",
            default: "false",
            desc: "Pulse animation on the indicator",
          },
          {
            prop: "Progress.showLabel",
            type: "boolean",
            default: "false",
            desc: "Shows numeric % label beside track",
          },
          {
            prop: "Spinner.colorScheme",
            type: "string",
            default: '"primary"',
            desc: "primary | success | danger | warning | info | dark | white | inherit | secondary",
          },
          {
            prop: "Spinner.size",
            type: "string",
            default: '"default"',
            desc: "xs | sm | default | lg | xl | xxl",
          },
          {
            prop: "Spinner.speed",
            type: "string",
            default: '"normal"',
            desc: "fast | normal | slow",
          },
        ]}
      />
    </Section>
...
const OverlaysSection = () => {
  ...
  return (
    <Section
      ...
      description="Animated modal with backdrop blur and configurable sizes; tooltip with dark/light/primary variants."
    >
      <DemoBlock
        label="Dialog sizes"
        code={`<Dialog>
        ...
        <Dialog open={open} onOpenChange={setOpen}>
          <DialogContent size={size}>
            <DialogHeader divider>
              ...
              <DialogDescription>
                This dialog uses backdrop-blur overlay, smooth scale-in
                animation, and structured Header/Body/Footer slots.
              </DialogDescription>
            </DialogHeader>
            <DialogBody>
              <p className="text-ds-sm text-muted-foreground leading-relaxed">
                The body area accepts any content. Use{" "}
                <code className="font-mono text-xs bg-muted px-1 rounded">
                  DialogBody
                </code>{" "}
                for padding consistency, or drop content directly into{" "}
                <code className="font-mono text-xs bg-muted px-1 rounded">
                  DialogContent
                </code>{" "}
                for full control.
          ...
          <Row>
            <Tooltip>
              <TooltipTrigger asChild>
                <Button size="sm">Dark (default)</Button>
              </TooltipTrigger>
              <TooltipContent>Black background · white text</TooltipContent>
            </Tooltip>
            <Tooltip>
        ...
        rows={[
          {
            ...
            type: "string",
            default: '"default"',
            desc: "sm | default | md | lg | xl | full",
          },
          {
            prop: "DialogContent.hideClose",
            type: "boolean",
            default: "false",
            desc: "Hides the built-in close button",
          },
          {
            prop: "DialogHeader.divider",
            type: "boolean",
            default: "false",
            desc: "Bottom divider line",
          },
          {
            prop: "DialogFooter.divider",
            type: "boolean",
            default: "true",
            desc: "Top divider line",
          },
          ...
          },
          {
            ...
            type: "number",
            default: "6",
            desc: "Gap between trigger and tooltip (px)",
          },
        ]}
      />
    </Section>
...
const CollapseSection = () => (
  <Section
    ...
    description="Animated expand/collapse with CSS grid-rows — no inline styles. Supports single or multiple open items."
  >
    <DemoBlock
      label="Single mode (default)"
      code={`<CollapseGroup type="single" defaultOpen="q1">
  <Collapse itemId="q1">
  ...
  <Collapse itemId="q2">
    ...
    >
      <CollapseGroup type="single" defaultOpen="q1">
        {[
          {
            id: "q1",
            q: "What is this component library?",
            a: "A production-ready design system built on TailwindCSS, ShadCN UI, and Radix primitives, styled with CSS custom properties for full theming support.",
          },
          {
            id: "q2",
            q: "How do I install it?",
            a: "Run npm install @ippis/app-layout-theme and import the CSS: import '@ippis/app-layout-theme/style.css'",
          },
          {
            id: "q3",
            q: "Does it support dark mode?",
            a: "Yes. Add the .dark class to <html> or <body> and all tokens automatically switch to the dark palette.",
          },
          {
            id: "q4",
            q: "Can I override the theme colors?",
            a: "Yes. Override any --color-* CSS custom property in your root stylesheet. All components read tokens at runtime.",
          },
        ].map(({ id, q, a }) => (
    ...
    <DemoBlock
      label="Multiple mode + ghost variant"
      code={`<CollapseGroup type="multiple">
  <Collapse itemId="a" variant="ghost">
        ...
        {[
          {
            ...
            label: "Featured item",
            content:
              "This uses iconPosition='start' and multiple mode — multiple panels can be open simultaneously.",
          },
          {
            id: "s2",
            ...
            content:
              "All text strings are passed as props, making localisation straightforward.",
          },
          {
            id: "s3",
            ...
            label: "TypeScript",
            content:
              "Every component is fully typed with exported interfaces. No @ts-ignore needed.",
          },
        ].map(({ id, icon, label, content }) => (
          <Collapse key={id} itemId={id}>
            <CollapseTrigger icon={icon} iconPosition="start">
              {label}
            </CollapseTrigger>
    ...
    <PropsTable
      rows={[
        {
          prop: "CollapseGroup.type",
          type: "string",
          default: '"single"',
          desc: '"single" closes others on open; "multiple" allows many open',
        },
        {
          prop: "CollapseGroup.defaultOpen",
          type: "string | string[]",
          default: "—",
          desc: "itemId(s) open on first render",
        },
        {
          prop: "CollapseGroup.divided",
          type: "boolean",
          default: "true",
          desc: "Adds divider lines between items",
        },
        {
          prop: "CollapseGroup.flush",
          type: "boolean",
          default: "false",
          desc: "Removes border and rounded corners",
        },
        {
          prop: "Collapse.itemId",
          type: "string",
          default: "—",
          desc: "Required when inside CollapseGroup",
        },
        {
          prop: "CollapseTrigger.icon",
          type: "ReactNode",
          default: "—",
          desc: "Custom icon (replaces default chevron)",
        },
        {
          prop: "CollapseTrigger.iconPosition",
          type: "string",
          default: '"end"',
          desc: '"start" | "end"',
        },
...
const ListGroupSection = () => (
  <Section
    ...
    icon={Rows3}
    title="List Group"
    description="Structured vertical lists with icon, badge, description, action, chevron, and href slots."
  >
    <DemoBlock
      label="Basic list"
      code={`<ListGroup>
  <ListGroupItem icon={<User />} description="Admin" badge={<Badge>Active</Badge>} chevron clickable>
    ...
    <DemoBlock
      label="Coloured variants"
      code={`<ListGroupItem variant="success">Success item</ListGroupItem>
...
<ListGroupItem variant="info">Info item</ListGroupItem>`}
    >
      <ListGroup className="max-w-sm" divided>
        <ListGroupItem
          ...
          action={
            <Button size="xs" variant="soft-primary">
              View
            </Button>
          }
        >
        ...
        <ListGroupItem variant="danger" icon={<XCircle className="h-4 w-4" />}>
          Danger variant
        </ListGroupItem>
        <ListGroupItem
          variant="warning"
        ...
        <ListGroupItem variant="info" icon={<Info className="h-4 w-4" />}>
          Info variant
        </ListGroupItem>
      </ListGroup>
    </DemoBlock>
    ...
    <DemoBlock
      label="Active & disabled states"
      code={`<ListGroupItem active>Active item</ListGroupItem>
<ListGroupItem disabled>Disabled item</ListGroupItem>`}
    >
      <ListGroup className="max-w-sm">
        <ListGroupItem clickable onClick={() => {}}>
          Normal item
        </ListGroupItem>
        <ListGroupItem active clickable onClick={() => {}}>
    ...
    <PropsTable
      rows={[
        {
          prop: "ListGroup.flush",
          type: "boolean",
          default: "false",
          desc: "Removes outer border and rounded corners",
        },
        {
          prop: "ListGroup.divided",
          type: "boolean",
          default: "true",
          desc: "Adds dividers between items",
        },
        {
          prop: "ListGroupItem.variant",
          type: "string",
          default: '"default"',
          desc: "default | primary | success | danger | warning | info",
        },
        {
          prop: "ListGroupItem.icon",
          type: "ReactNode",
          default: "—",
          desc: "Leading icon slot",
        },
        {
          prop: "ListGroupItem.badge",
          type: "ReactNode",
          default: "—",
          desc: "Right-side badge slot",
        },
        {
          prop: "ListGroupItem.action",
          type: "ReactNode",
          default: "—",
          desc: "Right-side action slot (button, link)",
        },
        {
          prop: "ListGroupItem.description",
          type: "string",
          default: "—",
          desc: "Muted sub-text below the label",
        },
        {
          prop: "ListGroupItem.chevron",
          type: "boolean",
          default: "false",
          desc: "Trailing chevron arrow",
        },
        {
          prop: "ListGroupItem.href",
          type: "string",
          default: "—",
          desc: "Renders item as an anchor tag",
        },
        {
          prop: "ListGroupItem.active",
          type: "boolean",
          default: "false",
          desc: "Applies active/selected styling",
        },
        {
          prop: "ListGroupItem.disabled",
          type: "boolean",
          default: "false",
          desc: "Dims and blocks interaction",
        },
      ]}
    />
  </Section>
...
const NavigationSection = () => (
  <Section
    ...
    icon={Navigation}
    title="Navigation"
    description="Breadcrumb, Dropdown Menu, and icon reference for building navigation patterns."
  >
    <DemoBlock
      label="Breadcrumb"
      code={`<Breadcrumb>
  ...
  <DropdownMenuContent>
    ...
    <DemoBlock
      label="Lucide icons — import guide"
      code={`// Direct import (recommended)
...
const IconsReferenceSections = () => (
  <Section
    ...
    description='Lucide React re-exported as Icons namespace. Use import { Icons } from "@ippis/app-layout-theme".'
  >
    <DemoBlock
      label="Usage patterns"
      code={`// Pattern 1 — namespace (from the theme package)
import { Icons } from "@ippis/app-layout-theme";
<Icons.Bell className="h-4 w-4" />
    ...
    >
      <div className="space-y-3">
        <Alert variant="info" icon={<Info className="h-4 w-4" />}>
          ...
          <AlertDescription>
            Lucide exports icons named{" "}
            <code className="font-mono text-xs">Badge</code>,{" "}
            <code className="font-mono text-xs">Calendar</code>,{" "}
            <code className="font-mono text-xs">Command</code>,{" "}
            <code className="font-mono text-xs">Sheet</code>,{" "}
            <code className="font-mono text-xs">Sidebar</code>, and{" "}
            <code className="font-mono text-xs">Table</code> — the same names as
            our UI components. The{" "}
            <code className="font-mono text-xs">Icons</code> namespace prevents
            ambiguity.
          </AlertDescription>
        </Alert>
        <Row>
          {[
            ...
            <div
              key={i}
              className="flex h-9 w-9 items-center justify-center rounded-lg border border-border bg-card hover:bg-muted/60 transition-colors"
            >
    ...
    <AppShell
      ...
      onAuthChange={(payload) => {
        ...
        console.log(
          ...
          payload.firstName,
          payload.lastName,
          payload.selectedEntitySector?.name,
        );
      }}
      menus={menus}
      ...
      sidebarHeader={
        <div className="px-4 py-3 border-b border-border flex items-center gap-2">
          ...
          <div className="min-w-0">
            ...
            <p className="text-ds-xs text-muted-foreground truncate">
              Component Docs
            </p>
          </div>
        </div>
    ...
    >
      ...
      <div id="home" className="mb-8 scroll-mt-20">
        <div className="flex items-center gap-3 mb-3">
          ...
          <div>
            <h1 className="text-ds-xxl font-bold text-foreground">
              Component Library
            </h1>
            <p className="text-ds-sm text-muted-foreground">
              @ippis/app-layout-theme · Interactive component showcase
            </p>
          </div>
        </div>
        <p className="text-ds-md text-muted-foreground max-w-2xl">
          Live demos, props tables, and copy-ready code snippets for every
          component in the design system. Built with TailwindCSS, ShadCN UI,
          Radix primitives, and CSS custom properties.
        </p>
      ...
      <footer className="mt-12 border-t border-border pt-6 pb-2 text-center text-ds-xs text-muted-foreground">
        @ippis/app-layout-theme · MIT License · Built with TailwindCSS + ShadCN
        UI + Radix
      </footer>
    </AppShell>
  );
